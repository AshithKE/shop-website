const BAKERY_WHATSAPP_NUMBER = '919876543210'

export default function WhatsAppButton() {
  const href = `https://wa.me/${BAKERY_WHATSAPP_NUMBER}?text=${encodeURIComponent(
    "Hi Philo's Cakes! I'd like to ask about placing an order."
  )}`
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lift hover:scale-110 active:scale-95 transition-transform duration-300"
    >
